...
class TotalCeiledHours
{
    ...
    {
        return (int) ceil(((new SecondsSinceJanuary1st1970($this->interval->ends()))->value() - (new SecondsSinceJanuary1st1970($this->interval->starts()))->value()) / 60 / 60);
    }
}
...
class FromISO8601DateTimeTest extends TestCase
{
    ...
    public function testEquals(string $left, string $right, string $value)
    {
        ...
        $this->assertEquals($value, $leftDate->value());
    }

    public function equalDates()
    {
        return [
            ['2017-07-03T23:59:59+00:00', '2017-07-03T00:00:00+00:00', '2017-07-03'],
            ['2017-07-03T00:00:00+00:00', '2017-07-03T23:59:59+00:00', '2017-07-03'],
            ['2017-07-03T00:00:00+12:00', '2017-07-03T23:59:59-11:30', '2017-07-03'],
        ];
    }
